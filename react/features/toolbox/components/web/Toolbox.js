...
import { Dialog, openDialog, toggleDialog } from '../../../base/dialog';
...
import { openBackgroundMenuDialog } from '../../../background-menu';
import {
...
class Toolbox extends Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this._onToolbarOpenBackgroundMenu = this._onToolbarOpenBackgroundMenu.bind(this);
    ...
    _doOpenBackgroundMenu() {
        this.props.dispatch(openBackgroundMenuDialog());
    }
    ...
    */
    ...
    _onToolbarOpenBackgroundMenu: () => void;
     ...
     * @returns {void}
     */
    _onToolbarOpenBackgroundMenu() {
        this._doOpenBackgroundMenu();
    ...
    _renderOverflowMenuContent() {
        ...
        return [
            ...
            <OverflowMenuItem
                ...
                icon={IconShareDesktop}
                key='backgroundmenu'
                onClick={this._onToolbarOpenBackgroundMenu}
