...
import { DialogCopy } from '../../base/dialog';
...
const urls = [
    'images/Images/BgImage.jpg',
    'images/Images/abstract.jpg',
    'images/Images/butterfly.jpg',
    'images/Images/fall.jpg',
    'images/Images/nature.jpg',
...
class FeedbackDialog extends Component<Props, State> {
    ...
    _handleSubmit(e) {
        ...
        var fil = document.getElementById("bgImg");
    }
    ...
    _onSubmit() {
        ...
        // dispatch(submitFeedback(scoreToSubmit, "This is test", conference));
