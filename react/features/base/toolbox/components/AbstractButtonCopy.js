...
import type { Styles } from './AbstractToolboxItemCopy';
import ToolboxItemCopy from './ToolboxItemCopy';
 ...
 */
export default class AbstractButtonCopy<P: Props, S: *> extends Component < P, S > {
    static defaultProps = {
