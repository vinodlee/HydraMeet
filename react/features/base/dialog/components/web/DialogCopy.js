...
import StatelessDialogCopy from './StatelessDialogCopy';
 ...
 */
class DialogCopy extends AbstractDialog<Props, State> {
    /**
    ...
    render() {
        ...
        return <StatelessDialogCopy {...props} />;
    }
...
export default connect()(DialogCopy);
